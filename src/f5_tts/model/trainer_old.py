        ...
        for epoch in range(skipped_epoch, self.epochs):
            ...
            for batch in current_dataloader:
                with self.accelerator.accumulate(self.model):
                    ...
                    target_rms = 0.1
                    ref_audio= "/nlsasfs/home/dibd/dibd-speech/iitm/arjung/exps/f5-exps/data_prep/indictts_v2/English/train/wavs/indictts_v2_English_0144281.wav"
                    ...
                    #text= "" 
                    #text_gen=[""]
                    text_gen= ["When there was nothing left for him to think about, he said to himself."]
                    ...
                    infer_text = [
                        text_inputs[0] + ([" "] if isinstance(text_inputs[0], list) else " ") + text_gen
                    ]
